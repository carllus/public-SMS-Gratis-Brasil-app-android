...
public abstract class MediationServerParameters {
    ...
    public void load(Map<String, String> parameters) throws MappingException {
        ...
        if (hashMap.isEmpty()) {
            C0461b.m508e("No server options fields detected.  To suppress this message either add a field with the @Parameter annotation, or override the load() method");
        }
        for (Map.Entry next : parameters.entrySet()) {
            ...
            if (field2 != null) {
                try {
                    ...
                    C0461b.m502b("Server Option '" + ((String) next.getKey()) + "' could not be set: Illegal Access");
                } catch (IllegalArgumentException e2) {
                    C0461b.m502b("Server Option '" + ((String) next.getKey()) + "' could not be set: Bad Type");
                }
            } else {
                C0461b.m508e("Unexpected Server Option: " + ((String) next.getKey()) + " = '" + ((String) next.getValue()) + "'");
            }
        }
        String str2 = null;
        for (Field field3 : hashMap.values()) {
            if (((Parameter) field3.getAnnotation(Parameter.class)).required()) {
                C0461b.m502b("Required Server Option missing: " + ((Parameter) field3.getAnnotation(Parameter.class)).name());
