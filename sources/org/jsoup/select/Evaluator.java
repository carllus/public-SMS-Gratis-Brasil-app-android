...
public abstract class Evaluator {
    ...
    public static final class C0593Id extends Evaluator {

        /* renamed from: id */
        private String f704id;

        public C0593Id(String id) {
            this.f704id = id;
        }

        public boolean matches(Element root, Element element) {
            return this.f704id.equals(element.mo7557id());
        }

        public String toString() {
            return String.format("#%s", new Object[]{this.f704id});
        }
    }
    ...
    public static abstract class CssNthEvaluator extends Evaluator {
        ...
        /* renamed from: a */
        protected final int f702a;

        /* renamed from: b */
        protected final int f703b;
        ...
        public boolean matches(Element root, Element element) {
            ...
            if (this.f702a == 0) {
                ...
                return true;
            } else if ((pos - this.f703b) * this.f702a < 0 || (pos - this.f703b) % this.f702a != 0) {
                return false;
            } else {
                return true;
            }
        ...
        public String toString() {
            if (this.f702a == 0) {
                return String.format(":%s(%d)", new Object[]{getPseudoClass(), Integer.valueOf(this.f703b)});
            } else if (this.f703b == 0) {
                return String.format(":%s(%dn)", new Object[]{getPseudoClass(), Integer.valueOf(this.f702a)});
            } else {
                return String.format(":%s(%dn%+d)", new Object[]{getPseudoClass(), Integer.valueOf(this.f702a), Integer.valueOf(this.f703b)});
            }
        }
    }
